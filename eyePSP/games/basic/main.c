...
int video_thread(SceSize args, void *argp) {
	...
	while (running) {
		...
		if (!aligned) {
			...
			blitAlphaImageToScreen(0, 0, 51, 51, imgSprites, 100, 100);
			blitAlphaImageToScreen(12, 52, 25, 25, imgSprites, 175, 150);
			blitAlphaImageToScreen(19, 79, 11, 11, imgSprites, 210, 200);
		}
